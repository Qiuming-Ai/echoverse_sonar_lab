 ...
 * It can be used in Qt projects to convert sonar_types_v2::samples::frame::Frame
 * to QImages
 *
 */
...
namespace frame_helper
{
    ...
    class FrameQImageConverter
    {
        public:
            ...
            //int copyFrameToQImageRGB888(QImage &dst,sonar_types_v2::samples::frame::frame_mode_t mode,int pixel_size, int width,int height,const char* pbuffer)
            //{
            int copyFrameToQImageRGB888(QImage &dst,sonar_types_v2::samples::frame::frame_mode_t mode,int pixel_size, unsigned int width,unsigned int height, const char* pbuffer, const size_t buffer_size=0)
            {
                ...
                switch(mode)
                {
                case sonar_types_v2::samples::frame::MODE_UNDEFINED:
                    throw std::runtime_error(" FrameQImageConverter::copyFrameToQImageRGB888: Unknown frame mode!");
                    break;

                case sonar_types_v2::samples::frame::MODE_BAYER_RGGB:
                case sonar_types_v2::samples::frame::MODE_BAYER_GRBG:
                case sonar_types_v2::samples::frame::MODE_BAYER_BGGR:
                case sonar_types_v2::samples::frame::MODE_BAYER_GBRG:
                    FrameHelper::convertBayerToRGB24((const uint8_t*)pbuffer,(uint8_t*) dst.bits(), width, height ,mode);
                    break;

		case sonar_types_v2::samples::frame::MODE_BGR:
		    ...
		    dst = dst.rgbSwapped();
                ...
                case sonar_types_v2::samples::frame::MODE_RGB:
		...
		case sonar_types_v2::samples::frame::MODE_UYVY:
                ...
                case sonar_types_v2::samples::frame::MODE_GRAYSCALE:
                {
                    switch(pixel_size)
                    {
                        case 1:
                ...
                case sonar_types_v2::samples::frame::MODE_RGB32:
                {
                    switch(pixel_size)
                    {
                        case 8:
                ...
                case sonar_types_v2::samples::frame::MODE_PNG:
                {
            ...
            int copyFrameToQImageRGB888(QImage &dst,const sonar_types_v2::samples::frame::Frame &frame)
            {
            ...
            {
                sonar_types_v2::samples::frame::frame_mode_t _mode =  sonar_types_v2::samples::frame::Frame::toFrameMode(mode.toStdString());
