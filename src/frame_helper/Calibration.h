...
{
    /**
     * Calibration parameters expressing the camera matrix and
     * the coefficients for the lens distortion.
     */
	 ...
	 */
	static CameraCalibration fromFrame( const sonar_types_v2::samples::frame::Frame& frame );
	 ...
	 * of the frame
	 */
	void toFrame( sonar_types_v2::samples::frame::Frame& frame ) const;
    };
